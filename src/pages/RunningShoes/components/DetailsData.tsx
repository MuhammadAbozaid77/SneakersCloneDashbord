    ...
    <>
      <div className="text-[18px] flex">
        ...
        <span className="mx-2 font-semibold">
          {runningshoesDetails?.detailsObject[0]?.id}
        </span>
      </div>
      <div className="text-[18px] flex">
        <span className="px-1 shadow min-w-[150px] bg-gray-200">
        ...
        <span className="mx-2 font-semibold">
          {runningshoesDetails?.detailsObject[0]?.productName}
        </span>
      </div>
      <div className="text-[18px] flex">
        <span className="px-1 shadow min-w-[150px] bg-gray-200">
        ...
        <span className="mx-2 font-semibold">
          {runningshoesDetails?.detailsObject[0]?.productPrice}
        </span>
      </div>
      <div className="text-[18px] flex">
        <span className="px-1 shadow min-w-[150px] bg-gray-200">
        ...
        <span className="mx-2 font-semibold">
          {runningshoesDetails?.detailsObject[0]?.productDescripition}
        </span>
      </div>
    </>
  );
